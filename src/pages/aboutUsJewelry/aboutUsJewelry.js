$(document).ready(function () {
    ...
    // FUNCIONES MEJORADAS DE AUTOPLAY
    ...
    function setupAutoPlayHover() {
        const carouselContainer = document.querySelector('.carousel-container');
        if (carouselContainer) {
            // Limpiar eventos previos para evitar duplicados
            carouselContainer.removeEventListener('mouseenter', pauseAutoPlay);
    ...
    function initCarousel() {
        if (slides.length > 0) {
            ...
            // Pausar autoplay cuando el mouse está sobre el carrusel (CORRECCIÓN)
            setupAutoPlayHover();
            setTimeout(() => {
                startAutoPlay();
            }, 2000);
